...
export default function Main() {
    ...
    return (
        <div>
            <GlobalStyles/> 
            <Planet src={green} size={30} x1={125} y1={15} panime={1} color={"#0AFF07"} x2={1} y2={-1} size2={30} title={3}/>
            <Planet src={sea} size={30} x1={145} y1={50} panime={2} color={"#00D2FF"} x2={-4} y2={-2} size2={35} title={1}/>
            <Planet src={red} size={30} x1={100} y1={50} panime={1} color={"#A20114"} x2={-4} y2={1} size2={30} title={2}/>
            <Planet src={electricity} size={35} x1={55} y1={41} panime={2} color={"#FFC634"} x2={5} y2={4} size2={25} title={4}/>
            <Planet src={poison_planet} size={30} x1={40} y1={71} panime={1} color={"#872CBF"} x2={1} y2={-1} size2={30} title={5}/>
